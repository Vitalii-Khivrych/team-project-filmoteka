function renderLibraryPlug() {
    return markup = `<div class="library-plug container">
      <p class="library-plug__text">Sorry ther is no content yet</p>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        id="icon-eye-blocked"
        class="library-plug__icon"
        viewBox="0 0 34 32"
        width="40"
        height="40"
      >
...
export default renderLibraryPlug;